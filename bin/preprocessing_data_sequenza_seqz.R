...
gc.stats  = gc.norm(x  = cn.data$depth.ratio,
...
#Output the BAF
baf         = data.frame(Name = paste0("chr",cn.data$chromosome,"_",cn.data$position),
                        Chr  = cn.data$chromosome,
                        Position = cn.data$position,
                        BAF = cn.data$Bf)

#Output the LRR
lrr         = data.frame(Name = paste0("chr",cn.data$chromosome,"_",cn.data$position),
                        Chr  = cn.data$chromosome,
                        Position = cn.data$position,
                        LRR = cn.data$lrr)

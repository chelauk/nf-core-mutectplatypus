...
# Write it out
write.table(mimmal_df, file = paste0(SAMPLENAME,"_mimmal_input.txt"), 
            sep = "\t", quote = F, row.names = F)

# Run MiMMAl
runMiMMAl(samplename = paste0(SAMPLENAME,"_mimmal"), inputfile = paste0(SAMPLENAME,"_mimmal_input.txt"), 
